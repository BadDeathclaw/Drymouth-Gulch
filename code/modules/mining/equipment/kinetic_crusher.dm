...
/obj/item/twohanded/required/kinetic_crusher
	...
	force = 72 //As much as a bone spear, but this is significantly more annoying to carry around due to requiring the use of both hands at all times
	w_class = WEIGHT_CLASS_BULKY
	slot_flags = ITEM_SLOT_BACK
	force_unwielded = 72 //It's never not wielded so these are the same
	force_wielded = 72
	throwforce = 5
	throw_speed = 4
	light_range = 5
