...
/obj/item/organ/liver/cybernetic/upgraded/advanced/on_life()
	...
	if(istype(C))
		if(!(C.reagents.has_reagent("mannitol", 10)))
			C.reagents.add_reagent("mannitol", 10)
		if(!(C.reagents.has_reagent("earthsblood", 10)))
			C.reagents.add_reagent("earthsblood", 10)
		if(!(C.reagents.has_reagent("tricordrazine", 10)))
			C.reagents.add_reagent("tricordrazine", 10)
		if(!(C.reagents.has_reagent("omnizine", 5)))
			C.reagents.add_reagent("omnizine", 5)
