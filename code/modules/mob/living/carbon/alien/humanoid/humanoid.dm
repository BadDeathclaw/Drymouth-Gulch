...
/mob/living/carbon/alien/humanoid/cuff_resist(obj/item/I)
	playsound(src, 'sound/voice/xenomorph/hiss5.ogg', 40, 1, 1)  //Alien roars when starting to break free
...
/mob/living/carbon/alien/humanoid/check_breath(datum/gas_mixture/breath)
	if(breath && breath.total_moles() > 0 && !sneaking)
		playsound(get_turf(src), pick('sound/voice/xenomorph/lowHiss2.ogg', 'sound/voice/xenomorph/lowHiss3.ogg', 'sound/voice/xenomorph/lowHiss4.ogg'), 50, 0, -5)
	..()
