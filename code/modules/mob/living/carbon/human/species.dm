...
/datum/species/proc/disarm(mob/living/carbon/human/user, mob/living/carbon/human/target, datum/martial_art/attacker_style)
	...
	if(user.loc == target.loc)
		...
		//Thank you based whoneedsspace and TG code
		...
		if(shove_blocked && !target.is_shove_knockdown_blocked() && !target.buckled)
			...
			if((!target_table && !target_collateral_human) || directional_blocked)
				...
				add_logs(user, target, "shoved", "knocking them down")
				...
				add_logs(user, target, "shoved", "onto [target_table] (table)")
				...
				add_logs(user, target, "shoved", "into [target_collateral_human.name]")
				...
				add_logs(user, target, "shoved", "into [target_disposal_bin] (disposal bin)")
		else
