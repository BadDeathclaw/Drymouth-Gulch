...
/obj/item/integrated_circuit/time/clock/bluespace
	name = "integrated clock (Global Absolute Time)"
	desc = "Tells you what the time is, in Global Absolute Time, unaffected by local time dilation or other phenomenon."
