...
/obj/item/clothing/head/helmet/space/hardsuit/powerarmor/advanced
	...
	desc = "It's an advanced power armor Mk I helmet, typically used by some USA divisions. It looks somewhat threatening."
...
/obj/item/clothing/suit/space/hardsuit/powerarmor/advanced
	...
	desc = "An advanced suit of armor typically used by the USA army.<br>It is composed of lightweight metal alloys, reinforced with ceramic castings at key stress points.<br>Additionally, like the T-51b power armor, it includes a recycling system that can convert human waste into drinkable water, and an air conditioning system for it's user's comfort."
...
/obj/item/clothing/head/helmet/space/hardsuit/powerarmor/mk2
	...
	desc = "It's an improved model of advanced power armor used exclusively by advanced military forces, developed after the Great War.<br>Like its older brother, the standard advanced power armor, it's matte black with a menacing appearance, but with a few significant differences - it appears to be composed entirely of lightweight ceramic composites rather than the usual combination of metal and ceramic plates.<br>Additionally, like the T-51b power armor, it includes a recycling system that can convert human waste into drinkable water, and an air conditioning system for it's user's comfort."
...
/obj/item/clothing/head/helmet/space/hardsuit/powerarmor/tesla
	...
	desc = "A helmet typically used by some special forces.<br>There are three orange energy capacitors on the side."
	icon_state = "tesla"
	item_state = "tesla"
...
/obj/item/clothing/suit/space/hardsuit/powerarmor/tesla
	...
	desc = "A variant of the advanced power armor Mk I, jury-rigged with a Tesla device that is capable of dispersing a large percentage of the damage done by directed-energy attacks.<br>As it's made of complex composite materials designed to block most of energy damage - it's notably weaker against kinetic impacts."
	icon_state = "tesla"
	item_state = "tesla"
