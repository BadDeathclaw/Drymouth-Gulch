/obj/item/clothing/head/f13/ncr
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 16, "energy" = 16, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
	strip_delay = 50
...
/obj/item/clothing/head/beret/ncr
	...
	armor = list("melee" = 30, "bullet" = 35, "laser" = 16, "energy" = 16, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
