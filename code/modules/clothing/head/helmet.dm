...
/obj/item/clothing/head/helmet/f13/legion/legrecruit
	...
	armor = list("melee" = 40, "bullet" = 25, "laser" = 10, "energy" = 10, "bomb" = 16, "bio" = 30, "rad" = 10, "fire" = 50, "acid" = 0)
	flags_inv = HIDEEARS|HIDEHAIR
	strip_delay = 50
	dynamic_hair_suffix = ""
	dynamic_fhair_suffix = ""
...
/obj/item/clothing/head/helmet/f13/legion/legrecruit/legprime
	...
	item_state = "legprim"
	icon_state = "legprim"
	armor = list("melee" = 50, "bullet" = 35, "laser" = 15, "energy" = 15, "bomb" = 25, "bio" = 40, "rad" = 15, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/legion/legvexil
	...
	icon_state = "legvexil"
	item_state = "legvexil"
	armor = list("melee" = 60, "bullet" = 40, "laser" = 25, "energy" = 15, "bomb" = 25, "bio" = 0, "rad" = 15, "fire" = 70, "acid" = 0)
	flags_inv = HIDEEARS|HIDEHAIR
	strip_delay = 50
	dynamic_hair_suffix = ""
	dynamic_fhair_suffix = ""
...
/obj/item/clothing/head/helmet/f13/legion/legdecan/vet
	...
	armor = list("melee" = 60, "bullet" = 40, "laser" = 25, "energy" = 15, "bomb" = 25, "bio" = 50, "rad" = 25, "fire" = 70, "acid" = 0)
	flags_inv = HIDEEARS|HIDEHAIR
	strip_delay = 50
	resistance_flags = LAVA_PROOF | FIRE_PROOF
	dynamic_hair_suffix = ""
...
/obj/item/clothing/head/helmet/f13/legion/legcenturion
	...
	armor = list("melee" = 75, "bullet" = 50, "laser" = 35, "energy" = 35, "bomb" = 39, "bio" = 60, "rad" = 30, "fire" = 80, "acid" = 0)
	flags_inv = HIDEEARS|HIDEHAIR
	strip_delay = 50
	resistance_flags = LAVA_PROOF | FIRE_PROOF
