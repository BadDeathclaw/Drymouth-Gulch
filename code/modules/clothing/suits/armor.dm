...
/obj/item/clothing/suit/armor/f13/rangercombat/desert
	...
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor = list("melee" = 65, "bullet" = 55, "laser" = 35, "energy" = 55, "bomb" = 55, "bio" = 60, "rad" = 60, "fire" = 90, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/rangercombat/eliteriot
	...
	armor = list("melee" = 70, "bullet" = 60, "laser" = 40, "energy" = 60, "bomb" = 60, "bio" = 60, "rad" = 60, "fire" = 90, "acid" = 0)
