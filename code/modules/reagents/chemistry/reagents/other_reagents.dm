...
/datum/reagent/spraytan
	...
	metabolization_rate = 10 * REAGENTS_METABOLISM // very fast, so it can be applied rapidly.  But this changes on an overdose no one loves your shit spraytan -oxford
	overdose_threshold = 121 //Slightly more than one un-nozzled spraybottle. also breaks the fuck out of this -oxford
