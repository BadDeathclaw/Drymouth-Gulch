...
/datum/objective/hijack
	...
	team_explanation_text = "Hijack the shuttle to ensure no loyalist Vault-Tec crew escape alive and out of custody. Leave no team member behind."
...
/datum/objective/absorb_most/check_completion()
	...
	for(var/datum/antagonist/changeling/changeling2 in GLOB.antagonists)
		if(!changeling2.owner || changeling2.owner == owner || !changeling2.stored_profiles || changeling2.absorbedcount < absorbedcount)			continue
		return FALSE
	return TRUE
