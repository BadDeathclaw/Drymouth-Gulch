...
/datum/game_mode/traitor/internal_affairs
	...
	reroll_friendly = 0
	traitor_name = "Vault-Tec Internal Affairs Agent"

	traitors_possible = 10 //hard limit on traitors if scaling is turned off
	num_modifier = 4 // Four additional traitors
	antag_datum = /datum/antagonist/traitor/internal_affairs

	announce_text = "There are Vault-Tec Internal Affairs Agents trying to kill each other!\n\
...
/datum/game_mode/traitor/internal_affairs/generate_report()
	return "Vault-Tec denies any accusations of placing internal affairs agents to eliminate inconvenient employees.  Any further accusations against Vault-Tec for such \
