...
/obj/item/card/id/ncrquartermaster
	name = "Quartermaster's tags"
	desc = "A chevron decorated dog tag showing NCO-ship.This one has an additional chevron indiciating a staff sergeant."
	icon_state = "ncrdogtagquartermaster"
