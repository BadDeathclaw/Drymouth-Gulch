...
/datum/interaction/lewd/fuck/anal/display_interaction(mob/living/user, mob/living/target)
	user.do_anal(target)
...
/datum/interaction/lewd/fingerass/display_interaction(mob/living/user, mob/living/target)
...
/datum/interaction/lewd/tribadism/display_interaction(mob/living/user, mob/living/target)
...
/datum/interaction/lewd/lickfeet/display_interaction(mob/living/user, mob/living/target)
...
/datum/interaction/lewd/grindface/display_interaction(mob/living/user, mob/living/target)
...
/datum/interaction/lewd/grindmouth/display_interaction(mob/living/user, mob/living/target)
