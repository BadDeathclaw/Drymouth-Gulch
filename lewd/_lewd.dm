...
/mob/living/carbon/proc/has_hand()
	if(get_num_arms() < 1)
		return FALSE
	return TRUE

/mob/living/carbon/proc/is_nude()
	return TRUE
...
/mob/living/carbon/proc/cum(mob/partner, target_orifice)
	var/message
...
/mob/living/carbon/proc/is_fucking(mob/partner, orifice)
	if(partner == last_partner && orifice == last_orifice)
		return TRUE
	return FALSE

/mob/living/carbon/proc/set_is_fucking(mob/partner, orifice)
	last_partner = partner
	last_orifice = orifice

/mob/living/carbon/proc/do_fucking_animation(fuckdir) // Today I wrote 'var/fuckdir' with a straight face. Not a milestone I ever expected to pass. dont worry, we dont use heretic proc/name(var/dir)
	if(!fuckdir)
		return
...
/mob/living/carbon/proc/do_oral(mob/partner)
	var/message
...
/mob/living/carbon/proc/do_facefuck(mob/partner)
	var/message
...
/mob/living/carbon/proc/thigh_smother(mob/partner)
...
/mob/living/carbon/proc/do_throatfuck(mob/partner)
	var/message
	...
	partner.dir = get_dir(partner,src)
	do_fucking_animation(get_dir(src, partner))
/mob/living/carbon/proc/nut_face(var/mob/partner)
...
/mob/living/carbon/proc/do_anal(mob/partner)
	var/message
...
/mob/living/carbon/proc/do_vaginal(mob/partner)
	var/message
...
/mob/living/carbon/proc/do_mount(mob/partner)
	var/message
...
/mob/living/carbon/proc/do_mountass(mob/partner)
	var/message
...
/mob/living/carbon/proc/do_fingering(mob/partner)
...
/mob/living/carbon/proc/do_fingerass(mob/partner)
...
/mob/living/carbon/proc/do_rimjob(mob/partner)
...
/mob/living/carbon/proc/do_handjob(mob/partner)
	var/message
...
/mob/living/carbon/proc/do_breastfuck(mob/partner)
	var/message
...
/mob/living/carbon/proc/do_mountface(mob/partner)
	var/message
...
/mob/living/carbon/proc/do_lickfeet(mob/partner)
	var/message
...
/mob/living/carbon/proc/do_grindface(mob/partner)
	var/message
...
/mob/living/carbon/proc/do_grindmouth(mob/partner)
	var/message
...
/mob/living/carbon/proc/get_shoes()
...
/mob/living/carbon/proc/handle_post_sex(amount, orifice, mob/partner)
	sleep(5)
